from PathAndDir import Dir2ClusterGraph, Dir2ViterbiOutFile, Dir2Figure_Result, Path2SelectedSerial
import igraph as ig
...
def do_work(serial):
    ...
    edge_deleted_id = [idx for idx, val in enumerate(EdgeLabel) if val==0]
    ...
    #G.delete_edges(edge_deleted_id)
    ...
    # figure.show()
    figure.save(os.path.join(Dir2Figure_Result, '{}.png'.format(str(serial))))
