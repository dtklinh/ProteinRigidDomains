from PathAndDir import Dir2SelectedDynDomEntry, Dir2ProteinGraph, Path2SelectedSerial
from Graph_Util_Funcs import ConstructProteinGraph
...
def do_work(serial):
    ...
    G = ConstructProteinGraph(Entry.DistanceMatrices, Entry.Membership,
    ...
    Path2GraphFile = os.path.join(Dir2ProteinGraph, '{}.pkl'.format(str(serial)))
